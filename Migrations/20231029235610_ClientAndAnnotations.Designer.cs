...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20231029235610_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2023, 10, 29, 19, 56, 10, 312, DateTimeKind.Local).AddTicks(7108),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2023, 10, 29, 19, 56, 10, 312, DateTimeKind.Local).AddTicks(7157),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2023, 10, 29, 19, 56, 10, 312, DateTimeKind.Local).AddTicks(7160),
                            ServicesID = 5
                        });
                });
